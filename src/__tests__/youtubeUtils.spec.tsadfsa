...
const {validateYouTubeUrl, checkYoutubeUrlForTimestamp} = require('../youtubeUtils');

test('returns proper result given a valid/invalid youtube url', function () {
    let urls =
...
test('returns undefined for a valid youtube url with no timestamp', function () {
    let urls =
...
test('returns proper value in seconds given a valid youtube url with a timestamp', function () {
    let urls =
